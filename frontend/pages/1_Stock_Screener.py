...
st.info("""
This page displays a consolidated view of stocks with their latest indicator scores, current prices, and 20-day rate of change (ROC).
...
if not data_rows:
    ...
    st.download_button(
        ...
        data=csv,
        file_name=f"stock_indicators_{current_date}.csv",
        mime="text/csv",
