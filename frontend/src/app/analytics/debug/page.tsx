                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <LineChart data={chartData}>
                            ...
                            <Line 
                              ...
                              strokeWidth={2}
                              dot={(props: any) => {
                                const key = `${props.payload.date}-${props.payload.isRebalance}`;
                                return props.payload.isRebalance ? 
                                  (<circle key={key} cx={props.cx} cy={props.cy} r={4} fill="#ef4444" />) : 
                                  (<circle key={key} cx={props.cx} cy={props.cy} r={2} fill="#2563eb" />);
                              }}
                            />
                          </LineChart>
                        </ResponsiveContainer>
